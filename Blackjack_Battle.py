...
def blackJack():
    global wins, buck_Health, player_Health
    wins = 0
    print("""
...
around and Dr. Buck has a deck of cards on his deck and asks if you want to play.
    ...
    while buck_Health>0 and player_Health>0:
        ...
        if hand_val_computer > 21:
            ...
            print(f"Dr. Buck busted. You deal {hand_val_player} to him. His health is now {buck_Health}.")
        elif hand_val_player > hand_val_computer:
            damage_Buck = hand_val_player-hand_val_computer
            buck_Health = buck_Health - damage_Buck
            print(f"You deal {damage_Buck} to Dr. Buck. His health is now {buck_Health}.")
            ...
            print(f"Dr. Buck deals {damage_player} to you. Your health is now {player_Health}.")
        else: 
