...
Dr. Buck and are a little embarrassed that you screamed. He questions you on
...
He wants to play a version of blackjack where the difference in value damages your health. 
    ...
    while buck_Health>0 and player_Health>0:
        ...
        print(f"Dr. Buck's first card is the {card2[0]} of {card2[1]}.")
        ...
        print(f"Dr. Buck flips over his hidden card and it is the {hidden_card4[0]} of {hidden_card4[1]} and their new total is {hand_val_computer}.")
        while hand_val_computer <= 21:
            if hand_val_computer <= 17:
                ...
                print(f"Dr. Buck draws the {drawcard[0]} of {drawcard[1]}. Their new total is {hand_val_computer}.")
            else:
                print(f"Dr. Buck stands with {hand_val_computer}.")
                break
...
and can move on with your college journey.
              """)
